			...
			if(e.metaKey || e.ctrlKey) {
				...
				switch (e.which || e.keyCode) {
					case 71:
						...
						if (!gw) gs.show(['d','db','tb','t','m'], [5,3,3,2,2], [1024,1024,768,768,320]);
...
if (window.location.href.match('gridset=show')) gs.show(['d','db','tb','t','m'], [5,3,3,2,2], [1024,1024,768,768,320]);
else gs.init(['d','db','tb','t','m'], [5,3,3,2,2], [1024,1024,768,768,320]);